...
If we consider (A, B) as a relation, then it defines a meet-semilattice
(lower semilattice), with a lower bound (which may be $\empty$), and
...
\includegraphics[width=0.45\textwidth]{py/rank_n=6_k=3.png}
\includegraphics[width=0.45\textwidth]{py/rank_n=8_k=4.png}
