...
\begin{document}
\title{
Small hyperclique covers would connect Shannon's
circuit counting bound to clique detection}
...
I am writing this up, although
it doesn't seem to give a bound larger than 1.
