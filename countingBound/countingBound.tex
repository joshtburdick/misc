...
$BUGGYCLIQUE(K_i) = k-CLIQUE$. (This suggests that doing so would
be difficult...)

\subsection{Comparing sets of functions using restrictions}

A standard method for showing lower bounds is to feed in 0's or
1's to particular inputs, and see what function and/or circuit remain.
...
This defines a slightly larger set of functions; unfortunately this doesn't
seem to help much.
