...
we plot all the possible sets of cliques on a rectangle, based on how many cliques $e$ ``hits'' or ``misses''.
...
how many cliques $e$ ``hits''. Hopefully, picking a distinguished edge $e$ reduces
the amount of overcounting we need to deal with.
