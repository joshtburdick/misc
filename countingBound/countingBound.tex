...
\begin{document}
\title{
Small hyperclique covers would allow Shannon's
counting argument to lower-bound clique detection}
...
The first component we use is basically Shannon's function-counting argument
